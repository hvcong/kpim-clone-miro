...
export default function PaperDetailModal() {
  const { showPaperDetailModal: show, setShowPaperDetailModal } = usePaperStore();
    ...
    >
      <div className='bg-white rounded-xl w-full max-w-lg p-10 text-sm'>
        <div className='flex space-x-6'>
          <div className=''>
            <div className='border border-gray-300 rounded-sm mb-2'>
              <img src='/board_icon.png' alt='paper thumb' className='w-36 h-36 rounded-sm' />
            </div>
          ...
          <div className='flex-1 space-y-2'>
            <div className='pb-2'>
              <input className='w-full outline-none pb-1 font-semibold text-xl' />
              <div className='w-full border-b border-gray-300'></div>
            </div>
            <div className='pb-2'>
              <input className='w-full outline-none pb-1' placeholder='Description' />
              <div className='w-full border-b border-gray-300'></div>
            </div>
            <div className='flex'>
        ...
        <div className='mt-6 flex justify-between'>
          <button className='px-4 py-1 border border-gray-300 rounded-sm'>Delete</button>

          <button className='px-4 py-1 border border-gray-300 rounded-sm'>Share</button>
        </div>
      </div>
    </Modal>
  );
